document.addEventListener('DOMContentLoaded', () => {
  ...
  // Create video element dynamically if it doesn't exist
  let modalVideoElement = document.getElementById('modal-video-element');
  if (!modalVideoElement && videoWrapper) {
    modalVideoElement = document.createElement('video');
    modalVideoElement.id = 'modal-video-element';
    modalVideoElement.controls = true;
    modalVideoElement.autoplay = true;
    modalVideoElement.playsInline = true;
    modalVideoElement.style.width = '100%';
    modalVideoElement.style.height = '100%';
    modalVideoElement.style.display = 'none';
    videoWrapper.appendChild(modalVideoElement);
  }
    ...
    frame.addEventListener('click', () => {
      ...
      if (videoId) {
        ...
        if (modalIframe) {
          ...
          modalIframe.src = `https://www.youtube.com/embed/${videoId}?autoplay=1&controls=1&rel=0`;
        }
